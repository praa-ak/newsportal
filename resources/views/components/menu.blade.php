        ...
        <div class="flex items-center">
            <ul class="flex items-center  font-medium text-xl ">
                <li>
                    ...
                    <li>
                        <a href="{{route('category',$item->slug)}}" class="text-gray-900 h-max w-max py-1 px-2 rounded-sm dark:text-white hover:bg-blue-800 hover:text-gray-100 " aria-current="">{{ $item->eng_name }}</a>
                    </li>
